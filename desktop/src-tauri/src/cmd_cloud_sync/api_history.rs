...
pub async fn send_single_play_history_to_cloud(
    ...
    let response = client
        ...
        .await
        .map_err(|e| {
            eprintln!("[Chordia Sync Error] addPlayHistory request failed: {}", e);
            format!("通信エラー: {}", e)
        })?;
...
pub async fn fetch_cloud_play_history(auth: State<'_, SharedAuthState>) -> Result<Value, String> {
    ...
    let response = client
        ...
        .await
        .map_err(|e| {
            eprintln!("[Chordia Sync Error] loadAllPlayHistory request failed: {}", e);
            format!("通信エラー: {}", e)
        })?;
...
pub async fn send_single_work_history_to_cloud(
    ...
    let response = client
        ...
        .await
        .map_err(|e| {
            eprintln!("[Chordia Sync Error] addWorkHistory request failed: {}", e);
            format!("通信エラー: {}", e)
        })?;
...
pub async fn fetch_cloud_work_history(auth: State<'_, SharedAuthState>) -> Result<Value, String> {
    ...
    let response = client
        ...
        .await
        .map_err(|e| {
            eprintln!("[Chordia Sync Error] loadAllWorkHistory request failed: {}", e);
            format!("通信エラー: {}", e)
        })?;
