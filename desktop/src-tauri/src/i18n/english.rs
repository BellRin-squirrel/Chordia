...
sync_desc = "Chordia Sync manages work sessions and playback history across devices online. This is separate from syncing audio files between Desktop and Mobile."
btn_start_sync_auth = "Authenticate with Chordia Sync"
sync_username_label = "Username"
sync_username_ph = "Enter account name..."
sync_username_desc = "The username is the account name you registered with Chordia Sync."
sync_device_label = "Login Device Name"
sync_device_ph = "e.g. Main Workstation PC"
sync_device_desc = "The login device name that will appear in your Chordia Sync device list upon successful login."
...
lang_pack_corrupted = "Some language packs could not be loaded."
"#;